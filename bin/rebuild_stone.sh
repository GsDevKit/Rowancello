...
installProject.stone file:/bosch1/users/dhenrich/_stones/37x/g_37x_externals_st/RowanV3/rowan/specs/Rowan.ston --alias=RowanV3 --projectsHome=/bosch1/users/dhenrich/_stones/37x/g_37x_externals_st -D -- -I .topazini_sys
